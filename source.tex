...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Senior Engineer & \href{mailto:scottalyons@gmail.com}{\color{urlcolor}{\faicon{envelope}} \color{textcolor} scottalyons} \\
  \textsl{Seattle, Washington} & \href{https://www.linkedin.com/in/theslyons/}{ \color{urlcolor}{\faicon{linkedin}} \color{textcolor} theslyons} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Contributed to the development and enhancement of the Spice.ai open-source product, focusing on integrating key functionality to improve usability and extend product capabilities.}
      \resumeItem{Authored comprehensive technical documentation, including API references and deployment guides, to support developer adoption and streamline product onboarding.}
      \resumeItem{Created and recorded instructional video content, explaining core product features, configuration steps, and usage scenarios to enhance user experience and facilitate knowledge transfer within the developer community.}
      ...
      \resumeItemListEnd
      \resumeTech{Technologies}{Rust, Apache DataFusion, Spark, AWS, Azure, Data Catalogs, Axum, Kubernetes}\\
    ...
    \resumeSubheading
      ...
      \resumeItem{Helped plan and automate data gathering for internal project that lead to key design decisions in ADLS Gen 2 (Hierarchical Namespaces)}
      \resumeItem{Wrote and iterated on Large-scale GDPR-enabled IoT Streaming project using Spark, EventHubs and Akka}
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
      \resumeTech{Technologies}{Python, Scala, F\#, C\#, Hadoop, HDInsight, D3.}\\
...
\section{Technical skills}
  ...
  \resumeSubItem{\textbf{Programming languages:} Python, Scala, Rust, F\#/.NET, JavaScript/Node}

...
Senior Engineer with over a decade of experience designing and building scalable data infrastructure, leading cross-functional engineering efforts, and mentoring teams across high-impact projects. Deep expertise in modern data processing frameworks such as Apache DataFusion, Spark, and Databricks, with a strong foundation in Rust, Python, and cloud-native architectures. Proven track record of translating complex business requirements into robust, performant systems across startups and enterprise environments.
